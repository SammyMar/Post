...
Suponha o exemplo inicial onde testamos $H_0: \theta \geq 5$ versus $H_1: \theta < 5$, sendo $\theta$ o tempo de duração médio das blusas da marca *A*, e que possuimos uma amostra $X_1,...X_{20} \sim Normal(\theta,1)$. Podemos obter o teste UMP para $\alpha = 0.05$ da seguinte forma:
